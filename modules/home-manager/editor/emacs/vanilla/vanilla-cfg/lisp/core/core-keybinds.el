...
(occhima/leader
  "TAB" '(:prefix-map occhima/workspace-map :wk "workspace")
  "b" '(:prefix-map occhima/buffer-map :wk "buffer")
  "c" '(:prefix-map occhima/code-map :wk "code")
  "f" '(:prefix-map occhima/file-map :wk "file")
  "g" '(:prefix-map occhima/git-map :wk "git")
  "i" '(:prefix-map occhima/insert-map :wk "insert")
  "j" '(:prefix-map occhima/just-map :wk "just")
  "m" '(:prefix-map occhima/local-leader-map :wk "localleader")
  "n" '(:prefix-map occhima/notes-map :wk "notes")
  "nr" '(:prefix-map occhima/roam-map :wk "roam")
  "O" '(:prefix-map occhima/agent-map :wk "opencode")
  "o" '(:prefix-map occhima/open-map :wk "open")
  "oa" '(:prefix-map occhima/agenda-map :wk "org agenda")
  "p" '(:prefix-map occhima/project-map :wk "project")
  "q" '(:prefix-map occhima/quit-map :wk "quit/session")
  "s" '(:prefix-map occhima/search-map :wk "search")
  "t" '(:prefix-map occhima/toggle-map :wk "toggle")
