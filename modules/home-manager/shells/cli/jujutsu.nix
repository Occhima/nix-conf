...
let
  ...
  cond = cfg.enable && builtins.elem "jujutsu" cfg.tools;
in
{
  config = mkIf cond {
    # totally stolen from https://github.com/isabelroses/dotfiles/blob/2dd74ed2316f4afa8b33473339b00daabf38821e/home/robin/packages/cli/jj.nix#L15
    programs.jujutsu = {
      enable = true;
      settings = {
        user = {
