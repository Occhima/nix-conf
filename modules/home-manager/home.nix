{ ... }:
{
  config.occhima.home.homeManager = (
    {
      config,
      lib,
      ...
    }:
    {
      options.modules = {
        ...
        # ponytail: minimal option for cross-aspect terminal name lookup (caelestia etc)
        desktop.terminal.active = lib.mkOption {
          type = lib.types.str;
          default = "";
          description = "Active terminal emulator binary name";
        };
      };
