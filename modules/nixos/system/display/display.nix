# Display stack fact. The wayland/x11 aspects import this and publish
  ...
  config.flake.modules.nixos.display-base =
    { lib, ... }:
    {
      options.modules.system.display.type = lib.mkOption {
        ...
        default = null;
        description = "The display server stack this host runs (published by the display aspects).";
      };
    };
}
